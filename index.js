    ...
    if (interaction.isCommand()) {
        ...
        if (commandName === 'send-embed') {
            ...
            const gutschein1 = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder().setCustomId('lol').setLabel('Leage of Legends').setEmoji('<:lol:1416166673945329694>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('roblox').setLabel('Roblox').setEmoji('<:Robux:1416166419539951731>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('fortnite').setLabel('Fortnite').setEmoji('<:Fortnite:1416168194770600108>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('ea').setLabel('EA Sports').setEmoji('<:ea:1416166551295492137> ').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('valorant').setLabel('Valorant').setEmoji('<:Valorant:1416070443361894435>').setStyle(ButtonStyle.Danger),
                );
            const gutschein2 = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder().setCustomId('razer').setLabel('Razor Gold').setEmoji('<:razer:1416168635839418539>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('steam').setLabel('Steam').setEmoji('<:steam:1416168755460968579>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('playsi').setLabel('PlayStation').setEmoji('<a:playsi:1416166359565467779>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('xbox').setLabel('Xbox').setEmoji('<:Xbox:1416169001377202317>').setStyle(ButtonStyle.Danger),
                );
            components = [gutschein1, gutschein2];

        } else if (commandName === 'game-embed') {
            embed = new EmbedBuilder()
                .setAuthor({
                    name: 'Trap Store',
                    iconURL: 'https://cdn.discordapp.com/attachments/1416049425931042928/1416145303244902491/trapstore.png?ex=68c5c797&is=68c47617&hm=500985a42e11d263bd4201af501f0e900e4540c46f5c75dd88cf4e1571e9818b&',
            ...
            const game1 = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder().setCustomId('rust').setLabel('Rust').setEmoji('<:__:1416166495565648004>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('gta5').setLabel('Grand Theft Auto V').setEmoji('<:GTA_5:1416166317677084682>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('forza').setLabel('Forza Horizon 5').setEmoji('<:Forza_by_patriotLV:1416166298119045160>').setStyle(ButtonStyle.Danger),
                );
            const game2 = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder().setCustomId('fifa').setLabel('EA SPORTS FC 25').setEmoji('<:ea:1416166551295492137>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('minecraft').setLabel('Minecraft').setEmoji('<:Minecraft:1416166337784315904>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('rdr2').setLabel('Red Dead').setEmoji('<:rdr2:1416166245903892672>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('euro').setLabel('Euro Truck').setEmoji('<:euro79:1416166572665602138>').setStyle(ButtonStyle.Danger),
                );
            components = [game1, game2];

        } else if (commandName === 'phone-embed') {
            embed = new EmbedBuilder()
                .setAuthor({
                    name: 'Trap Store',
                    iconURL: 'https://cdn.discordapp.com/attachments/1416049425931042928/1416145303244902491/trapstore.png?ex=68c5c797&is=68c47617&hm=500985a42e11d263bd4201af501f0e900e4540c46f5c75dd88cf4e1571e9818b&',
            ...
            const handy1 = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder().setCustomId('wild').setLabel('Wild Rift').setEmoji('<:lol:1416166673945329694>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('strike').setLabel('Blood Strike').setEmoji('<:images:1416166655243063337>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('fire').setLabel('Free Fire').setEmoji('<:free_fire48:1416166636821680248>').setStyle(ButtonStyle.Danger),
                );
            const handy2 = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder().setCustomId('pubg').setLabel('PUBG Mobile').setEmoji('<:PUBG:1416166380734124203>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('roblox').setLabel('Roblox').setEmoji('<:Robux:1416166419539951731>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('handy_fifa').setLabel('Efootball 2024').setEmoji('<:ea:1416166551295492137>').setStyle(ButtonStyle.Danger),
                );
            components = [handy1, handy2];

        } else if (commandName === 'social-embed') {
            embed = new EmbedBuilder()
                .setAuthor({
                    name: 'Trap Store',
                    iconURL: 'https://cdn.discordapp.com/attachments/1416049425931042928/1416145303244902491/trapstore.png?ex=68c5c797&is=68c47617&hm=500985a42e11d263bd4201af501f0e900e4540c46f5c75dd88cf4e1571e9818b&',
            ...
            const social1 = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder().setCustomId('insta').setLabel('Instagram').setEmoji('<:yinstagram:1416165491810111629>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('face').setLabel('Facebook').setEmoji('<a:facebook:1416166593636991047>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('tiktok').setLabel('Tiktok').setEmoji('<:youtubeshort:1416165451922280538>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('youtube').setLabel('Youtube').setEmoji('<:youtube:1416165255817466031>').setStyle(ButtonStyle.Danger),
                );
            components = [social1];

        } else if (commandName === 'discord-embed') {
            embed = new EmbedBuilder()
                .setAuthor({
                    name: 'Trap Store',
                    iconURL: 'https://cdn.discordapp.com/attachments/1416049425931042928/1416145303244902491/trapstore.png?ex=68c5c797&is=68c47617&hm=500985a42e11d263bd4201af501f0e900e4540c46f5c75dd88cf4e1571e9818b&',
            ...
            const discord = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder().setCustomId('nitro').setLabel('Nitr0').setEmoji('<a:Nitro:1416165056537694318>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('boost').setLabel('Bo0sts').setEmoji('<a:zeddnitroboostinglevel:1416165089320370246>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('effects').setLabel('Effe9ts').setEmoji('<:discord:1416165178868764762>').setStyle(ButtonStyle.Danger),
                );
            components = [discord];

        } else if (commandName === 'streaming-embed') {
            embed = new EmbedBuilder()
                .setAuthor({
                    name: 'Trap Store',
                    iconURL: 'https://cdn.discordapp.com/attachments/1416049425931042928/1416145303244902491/trapstore.png?ex=68c5c797&is=68c47617&hm=500985a42e11d263bd4201af501f0e900e4540c46f5c75dd88cf4e1571e9818b&',
            ...
            const streaming = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder().setCustomId('netflix').setLabel('Netflix').setEmoji('<:netflix:1416070475976806572>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('spotify').setLabel('Spotify Premium').setEmoji('<:spotify:1416070571061543003>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('crunchyroll').setLabel('Crunchyroll').setEmoji('<:Crunchyroll:1416184340542390395>').setStyle(ButtonStyle.Danger),
                    new ButtonBuilder().setCustomId('shahid').setLabel('Shahid VIP').setEmoji('<:shahid:1416184497518673971>').setStyle(ButtonStyle.Danger),
                );
        ...
        if (customId === 'lol') {
            ...
            embed = new EmbedBuilder()
                ...
                .setTimestamp()
                .setFooter({ text: 'All rights reserved to Brxtty', iconURL: 'https://cdn.discordapp.com/attachments/1416049425931042928/1416145303244902491/trapstore.png?ex=68c5c797&is=68c47617&hm=500985a42e11d263bd4201af501f0e900e42489319ac6088b8bef04d74dd606&' });

        } else if (customId === 'xbox') {
            embed = new EmbedBuilder()
                .setColor(0xFF0000)
        ...
        } else if (customId === 'fifa') {
            embed = new EmbedBuilder()
                .setColor(0xFF0000)
                .setAuthor({ name: 'EA SPORTS FC 25' }) // Korrigiert
                .setTitle('EA SPORTS FC 25 Acc0unt = 35 TND') // Korrigiert
                .setDescription(
                    `**kol Acc0unt nbi3ouh raw m3moul mi team te3na w enty awel wa7d bch tchrih!**\n\n` +
                    `- **Acc0unt yjik b email b kol chay (fresh)**\n` +
                    `- **lzmk tbdl info w securi Acc0unt t3k .. mnech ms2oulin 3al info t3 Acc0unt b3d mnbi3ouh so lzm tit2kd min kol chay meloul**\n` +
        ...
        } else if (customId === 'minecraft') {
            embed = new EmbedBuilder()
                .setColor(0xFF0000)
                .setAuthor({ name: 'Minecraft' }) // Korrigiert
                .setTitle('Minecraft Acc0unt java+bedrock editio = 35 TND') // Korrigiert
                .setDescription(
                    `**kol Acc0unt nbi3ouh raw m3moul mi team te3na w enty awel wa7d bch tchrih!**\n\n` +
                    `- **Acc0unt yjik b email b kol chay (fresh)**\n` +
                    `- **lzmk tbdl info w securi Acc0unt t3k .. mnech ms2oulin 3al info t3 Acc0unt b3d mnbi3ouh so lzm tit2kd min kol chay meloul**\n` +
        ...
        } else if (customId === 'rdr2') {
            embed = new EmbedBuilder()
                .setColor(0xFF0000)
                .setAuthor({ name: 'Red Dead' }) // Korrigiert
                .setTitle('Red Dead 5 Steam Acc0unt = 55 TND') // Korrigiert
                .setDescription(
                    `**kol Acc0unt nbi3ouh raw m3moul mi team te3na w enty awel wa7d bch tchrih!**\n\n` +
                    `- **Acc0unt yjik b email b kol chay (fresh)**\n` +
                    `- **lzmk tbdl info w securi Acc0unt t3k .. mnech ms2oulin 3al info t3 Acc0unt b3d mnbi3ouh so lzm tit2kd min kol chay meloul**\n` +
        ...
        } else if (customId === 'euro') {
            embed = new EmbedBuilder()
                .setColor(0xFF0000)
                .setAuthor({ name: 'Euro Truck' }) // Korrigiert
                .setTitle('Euro Truck Steam Acc0unt = 15 TND') // Korrigiert
                .setDescription(
                    `**kol Acc0unt nbi3ouh raw m3moul mi team te3na w enty awel wa7d bch tchrih!**\n\n` +
                    `- **Acc0unt yjik b email b kol chay (fresh)**\n` +
                    `- **lzmk tbdl info w securi Acc0unt t3k .. mnech ms2oulin 3al info t3 Acc0unt b3d mnbi3ouh so lzm tit2kd min kol chay meloul**\n` +
        ...
        } else if (customId === 'crunchyroll') { // Korrigiert
            embed = new EmbedBuilder()
                .setColor(0xFF0000)
                .setAuthor({ name: 'Crunchyroll' }) // Korrigiert
                .setDescription(
        ...
        } else if (customId === 'shahid') {
            embed = new EmbedBuilder()
                .setColor(0xFF0000)
                .setAuthor({ name: 'Shahid VIP' }) // Korrigiert
                .setDescription(
                    `**Comming soon...**`,
                )
                .setTimestamp()
...
client.on('ready', () => {
    client.guilds.cache.forEach(async guild => {
        await guild.commands.set([
            { name: 'send-embed', description: 'sends giftcard embed.' },
            { name: 'game-embed', description: 'Game Product embed.' },
            { name: 'phone-embed', description: 'Phone Game Points embed.' },
            { name: 'social-embed', description: 'Social Media Pr0ducts.' },
            { name: 'discord-embed', description: 'Disc0rd Pr0ducts.' },
            { name: 'streaming-embed', description: 'Streaming Pr0ducts.' },
        ]);
    });
});
